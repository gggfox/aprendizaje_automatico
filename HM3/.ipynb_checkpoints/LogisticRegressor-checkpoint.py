...
class LogisticRegressor():
    # Construct a LogisticRegressor object.
    ...
    # Cost function. Sum the cost + sum of the numpy all_but_theta
    ...
    def fit(self, X, y):
        ...
        for i in range(self.epochs):
            ...
            # Check the boolean regularize to change the gradient and theta accordingly.
            if self.regularize:
